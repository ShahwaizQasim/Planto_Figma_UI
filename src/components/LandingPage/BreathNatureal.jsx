  ...
  return (
    <Layout>
      <div className="flex justify-between px-8 z-20">
        ...
        <div className="bg-[linear-gradient(90deg,rgba(255,255,255,0.2)_0%,rgba(0,0,0,0)_52%,rgba(255,255,255,0.2)_100%)] bg-[#1a2016] opacity-100 w-72 pt-5 pb-10 rounded-xl p-4 mt-12 z-20 relative md:left-8 md:bottom-10">
